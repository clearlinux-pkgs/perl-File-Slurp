...
Source0  : https://cpan.metacpan.org/authors/id/C/CA/CAPOEIRAB/File-Slurp-9999.29.tar.gz
...
%package perl
Summary: perl components for the perl-File-Slurp package.
Group: Default
Requires: perl-File-Slurp = %{version}-%{release}

%description perl
perl components for the perl-File-Slurp package.


%prep
%setup -q -n File-Slurp-9999.29
cd %{_builddir}/File-Slurp-9999.29
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/File/Slurp.pm
